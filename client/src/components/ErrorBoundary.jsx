        ...
        <div className="flex items-center justify-center min-h-screen bg-background">
          <div className="max-w-md w-full bg-surface rounded-lg p-8 border border-border">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <div className="mb-4 p-3 bg-background rounded border border-border text-xs">
                <p className="font-mono text-red-400 break-all">
                  {this.state.error.toString()}
                </p>
                {this.state.errorInfo && (
                  <details className="mt-2 text-text-secondary text-xs">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 px-4 py-2 bg-primary text-white text-sm font-semibold rounded-md hover:bg-primary-hover transition-colors"
              >
                Refresh Page
              </button>
              <button
