...
export default function NotesList() {
  ...
  const handleDownload = (note) => {
    const content = `CampusConnect Document\n\n` +
      `Title: ${note.title}\n` +
    ...
    dispatch(incrementDownloadCount(note._id || note.id));
  ...
  const getFileIcon = (type) => {
    switch (type) {
      ...
      default: return { icon: 'folder', color: 'text-text-secondary', bg: 'bg-gray-500/10' };
    }
  };
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto w-full custom-scrollbar relative">
        {toastMessage && (
          <div className="absolute top-6 left-1/2 -translate-x-1/2 z-50 bg-primary text-white px-6 py-3 rounded-lg shadow-xl font-medium flex items-center gap-2 animate-bounce">
        ...
        <div className="p-4 sm:p-8 lg:p-12 max-w-7xl mx-auto space-y-8">
          ...
          <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-6 border-b border-border">
            <div>
              <h1 className="text-3xl font-extrabold text-text-primary tracking-tight">Notes & Documents</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              <div className="md:col-span-5 relative">
                ...
                <input
                  ...
                  className="w-full bg-background border border-border text-text-primary pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:border-blue-500 transition-colors"
                />
              </div>
              <div className="md:col-span-3">
                <select
                  ...
                  className="w-full bg-background border border-border text-text-primary py-2 px-3 rounded-lg focus:outline-none focus:border-blue-500 appearance-none"
                >
          ...
          {status === 'loading' ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {notes.map(note => {
                ...
                return (
                  <div key={note._id || note.id} className="bg-surface border border-border rounded-xl overflow-hidden hover:border-[#475569]/50 transition-colors flex flex-col group">
                    <div className="p-5 flex-1 relative">
                      ...
                      <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                        <button
                          ...
                          className="w-8 h-8 rounded bg-background border border-border text-text-secondary hover:text-text-primary flex items-center justify-center transition-colors"
                        ...
                        <button
                          ...
                          className="w-8 h-8 rounded bg-background border border-border text-text-secondary hover:text-[#DC2626] hover:border-[#DC2626]/50 flex items-center justify-center transition-colors"
                          title="Delete"
                        >
                      ...
                      <h3 className="font-bold text-text-primary text-lg leading-tight mb-1 line-clamp-2" title={note.title}>
                        {note.title}
                      </h3>
            ...
            <div className="flex flex-col gap-4 py-16 px-4 rounded-xl border border-border bg-surface items-center justify-center text-center">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-1">No notes found</h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/70 backdrop-blur-sm">
          <div className="bg-surface border border-border w-full max-w-lg rounded-xl shadow-2xl flex flex-col">
            <div className="flex items-center justify-between p-5 border-b border-border">
              <h3 className="text-xl font-bold text-text-primary">Upload Document</h3>
              <button
            ...
            <form onSubmit={handleUploadSubmit} className="p-6 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-background border border-border text-text-primary px-4 py-2 rounded-lg focus:outline-none focus:border-blue-500 transition-colors"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-background border border-border text-text-primary px-4 py-2 rounded-lg focus:outline-none focus:border-blue-500 appearance-none"
                >
              ...
              <div className="pt-4 flex items-center justify-end gap-3 border-t border-border">
                <button
                  type="button"
                  onClick={() => setIsUploadModalOpen(false)}
                  className="px-5 py-2 text-sm font-semibold text-text-primary hover:text-text-primary transition-colors"
                >
                  Cancel
                </button>
                <button
