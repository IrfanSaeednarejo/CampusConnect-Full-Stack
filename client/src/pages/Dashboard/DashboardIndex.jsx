...
const DashboardIndex = () => {
  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden bg-background">
      {/* Mobile Header */}
      <header className="sticky top-0 z-50 w-full border-b border-border bg-surface/80 backdrop-blur-sm lg:hidden">
        <div className="container mx-auto flex items-center justify-between whitespace-nowrap px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex items-center gap-8">
            ...
            >
              ...
              <h2 className="text-text-primary text-lg font-bold tracking-[-0.015em]">
                CampusConnect
              </h2>
            </div>
          </div>
          <div className="flex flex-1 items-center justify-end gap-4">
            <button className="flex items-center justify-center rounded-lg h-10 w-10 border border-border bg-surface text-text-primary hover:bg-surface-hover text-sm font-bold px-2.5">
      ...
      <div className="flex flex-1">
        ...
        <div className="flex flex-col flex-1">
          {/* Desktop Header */}
          <header className="sticky top-0 z-50 w-full border-b border-border bg-surface/80 backdrop-blur-sm hidden lg:block">
              ...
              <div className="flex flex-1 items-center justify-end gap-4">
                <label className="hidden flex-col min-w-40 !h-10 max-w-64 sm:flex">
                  <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
                    <div className="text-text-secondary flex border border-border bg-background items-center justify-center pl-3 rounded-l-lg border-r-0">
                      <span className="material-symbols-outlined text-xl">search</span>
                    </div>
                    <input
                      className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-text-primary focus:outline-0 focus:ring-1 focus:ring-primary border border-border bg-background h-full placeholder:text-text-secondary px-2 rounded-l-none border-l-0 text-sm font-normal leading-normal"
                      placeholder="Search..."
                    />
                  </div>
                </label>
          ...
          <main className="layout-container flex h-full grow flex-col bg-background">
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  ...
                  <div className="flex flex-col gap-6 lg:col-span-2">
                    ...
                    <div className="flex flex-col rounded-lg border border-border bg-surface">
                      <div className="border-b border-border px-4 pb-3 pt-5 sm:px-6">
                      ...
                      <div className="flex flex-col divide-y divide-border">
                        {upcomingEvents.length > 0 ? (
                          ...
                          <div className="flex flex-col items-center justify-center py-10 text-center">
                            <span className="material-symbols-outlined text-3xl text-text-secondary mb-2">event_busy</span>
                    ...
                    <div className="flex flex-col rounded-lg border border-border bg-surface">
                      ...
                      <div className="p-4 sm:p-6">
                        <div className="flex flex-col items-center gap-3 rounded-lg border border-border bg-background p-6 text-center">
                          <span className="material-symbols-outlined text-4xl text-text-secondary">school</span>
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-3 rounded-lg border border-border bg-surface p-4 sm:p-6">
                      <button
                        ...
                        className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg h-10 bg-primary text-white text-sm font-bold hover:bg-primary/90 transition-colors"
                      >
...
const EventItem = ({ title, date }) => (
  <div className="flex items-center gap-4 px-4 min-h-[72px] py-3 justify-between sm:px-6">
    <div className="flex flex-1 items-center gap-4 overflow-hidden">
      <div className="text-text-primary flex items-center justify-center rounded-lg bg-surface-hover shrink-0 size-12">
        <span className="material-symbols-outlined">event</span>
      </div>
      <div className="flex flex-col justify-center overflow-hidden">
        <p className="text-text-primary text-base font-medium leading-normal truncate">{title}</p>
        <p className="text-text-secondary text-sm font-normal leading-normal truncate">{date}</p>
      </div>
    </div>
    <button className="text-sm font-medium leading-normal text-primary hover:underline shrink-0">
      View Details
    </button>
  </div>
);
...
const ActivityItem = ({ img, icon, text, time }) => (
  <div className="flex items-start gap-4 p-4 sm:p-6">
    {img ? (
      <Avatar src={img} size="8" className="shrink-0 mt-1" />
    ) : (
      <div className="text-text-primary flex items-center justify-center rounded-full bg-surface-hover size-8 shrink-0 mt-1">
