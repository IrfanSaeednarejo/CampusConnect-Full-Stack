...
export const getMyBookings = async (queryParams, requestUser) => {
    ...
    return await paginate(MentorBooking, filter, {
        ...
        populate: [
            ...
            { path: "menteeId", select: "profile.displayName profile.avatar profile.firstName profile.lastName email academic.department" },
            { path: "reviewId", select: "rating comment isAnonymous detailedRatings createdAt" },
        ],
    });
};
