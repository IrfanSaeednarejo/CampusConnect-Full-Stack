...
export const EventTypes = {
    ...
    // NEXUS AI EVENTS
    NEXUS_NOTE_CREATED: "NEXUS_NOTE_CREATED@v1",
    NEXUS_TASK_CREATED: "NEXUS_TASK_CREATED@v1",
    NEXUS_TASK_REMINDER: "NEXUS_TASK_REMINDER@v1",
    NEXUS_ACTION_COMPLETED: "NEXUS_ACTION_COMPLETED@v1",
};
